...
public class ServerGUI extends Application {
    ...
    Text gameWelcome,clientNo, playerMove, playerPoints, gameWin, playAgain;
    Stage myStage;
    Scene scene;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("Spaceman Charades Server");
        myStage = primaryStage;
        gameWelcome = new Text("Welcome to Space Man Charades" + "\n" + "Please press the button to start server");
        ...
        VBox paneCenter = new VBox(10, gameWelcome, serverOn);
